Project doesn't import correctly using Eclipse. Project must be built by creating a new Project and dragging all files across into the new Project Repo.
